    ...
    >
      ...
      <div v-if="page === 'guide'" class="application-dialog__content help-guide">
        ...
        <section>
          ...
          <p>Язык можно выбрать на стартовой странице или в меню Файл → Настройки программы…. Переводятся меню, кнопки, подсказки и окна программы. Церковные данные календаря и введённый вами текст не переводятся.</p>
        </section>
        <section>
