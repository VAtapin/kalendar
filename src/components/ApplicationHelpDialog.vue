    ...
    >
      ...
      <div v-if="page === 'guide'" class="application-dialog__content help-guide">
        ...
        <section>
          ...
          <p>Параметр «Скругление» действует на любой объект. Инструмент «Маска» работает неразрушающе: режим «Скрыть» убирает проведённую кистью область, а «Вернуть» снова проявляет её. Исходный объект при этом не меняется.</p>
        </section>
        <section>
          <h3>Печать</h3>
      ...
      <div v-else-if="page === 'shortcuts'" class="application-dialog__content">
        <table class="shortcut-table">
          <tbody>
            ...
            <tr><td>Маска объекта</td><td><kbd>Q</kbd></td></tr>
