...
const TRANSLATIONS: Record<string, Translation> = {
  ...
  "Моя корзина": {de:"Mein Papierkorb",en:"My trash",uk:"Мій кошик"},
  "Корзина пуста.": {de:"Der Papierkorb ist leer.",en:"Trash is empty.",uk:"Кошик порожній."},
  "Вернуть календарь": {de:"Kalender wiederherstellen",en:"Restore calendar",uk:"Відновити календар"},
  "Закрыть корзину": {de:"Papierkorb schließen",en:"Close trash",uk:"Закрити кошик"},
  "Дата удаления:": {de:"Gelöscht am:",en:"Deleted on:",uk:"Дата видалення:"},
  "Дата удаления неизвестна": {de:"Löschdatum unbekannt",en:"Deletion date unknown",uk:"Дата видалення невідома"},
  ...
  "Создать аккаунт": {de:"Konto erstellen",en:"Create account",uk:"Створити обліковий запис"},
  "Видеоуроки": {de:"Videoanleitungen",en:"Video tutorials",uk:"Відеоуроки"},
  "Как пользоваться? Видеоуроки": {de:"Wie funktioniert es? Videoanleitungen",en:"How does it work? Video tutorials",uk:"Як користуватися? Відеоуроки"},
  "Смотреть": {de:"Ansehen",en:"Watch",uk:"Дивитися"},
  "Короткие видео о работе в Календарной мастерской.": {de:"Kurze Videos zur Arbeit in der Kalenderwerkstatt.",en:"Short videos about using the Calendar Workshop.",uk:"Короткі відео про роботу в Календарній майстерні."},
  "Видеоуроки готовятся к публикации.": {de:"Die Videoanleitungen werden vorbereitet.",en:"Video tutorials are being prepared.",uk:"Відеоуроки готуються до публікації."},
  "Нажимая «Смотреть», вы загружаете проигрыватель и устанавливаете соединение с YouTube.": {de:"Mit einem Klick auf „Ansehen“ laden Sie den Player und stellen eine Verbindung zu YouTube her.",en:"Clicking Watch loads the player and connects to YouTube.",uk:"Натискаючи «Дивитися», ви завантажуєте програвач і встановлюєте з’єднання з YouTube."},
  "Сначала выберите календарную сетку": {de:"Wählen Sie zuerst das Kalenderraster aus",en:"Select the calendar grid first",uk:"Спочатку виберіть календарну сітку"},
  "Забыли пароль?": {de:"Passwort vergessen?",en:"Forgot password?",uk:"Забули пароль?"},
  "Восстановление пароля": {de:"Passwort zurücksetzen",en:"Reset password",uk:"Відновлення пароля"},
  ...
  "Свойства календаря": { de: "Kalendereigenschaften", en: "Calendar properties", uk: "Властивості календаря" },
  "Разные форматы": { de: "Unterschiedliche Formate", en: "Mixed formats", uk: "Різні формати" },
  "Ориентация календаря": { de: "Kalenderausrichtung", en: "Calendar orientation", uk: "Орієнтація календаря" },
  "Формат и ориентация применяются ко всем страницам календаря, включая обложку.": { de: "Format und Ausrichtung gelten für alle Kalenderseiten einschließlich des Deckblatts.", en: "Format and orientation apply to every calendar page, including the cover.", uk: "Формат і орієнтація застосовуються до всіх сторінок календаря, включно з обкладинкою." },
  ...
  "Строгая уставная мера с сухоядением и днями полного воздержания. Не личное предписание всем пользователям.": { de: "Strenge Typikon-Regel mit Trockenkost und Tagen vollständigen Nahrungsverzichts. Keine persönliche Vorschrift für alle Nutzer.", en: "Strict Typikon measure with dry eating and days of complete abstinence from food. Not a personal obligation for every user.", uk: "Сувора уставна міра із сухоїдінням і днями повного утримання від їжі. Не особистий припис усім користувачам." },
  "Приходской вариант таблицы постов. Не заменяет правила вашей общины и личную меру поста.": { de: "Gemeindevariante der Fastentabelle. Ersetzt weder die Regeln Ihrer Gemeinde noch Ihr persönliches Fastenmaß.", en: "Parish version of the fasting table. Does not replace your community's rules or your personal fasting measure.", uk: "Парафіяльний варіант таблиці постів. Не замінює правила вашої громади та особисту міру посту." },
  "Выбор действует только в этом календаре. Местные обычаи одного монастыря или прихода не являются общими правилами программы.": { de: "Die Auswahl gilt nur für diesen Kalender. Örtliche Bräuche eines Klosters oder einer Gemeinde sind keine allgemeinen Regeln des Programms.", en: "This choice applies only to this calendar. Local customs of one monastery or parish are not universal rules of the program.", uk: "Вибір діє лише в цьому календарі. Місцеві звичаї одного монастиря чи парафії не є загальними правилами програми." },
