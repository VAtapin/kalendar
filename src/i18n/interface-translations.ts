...
export const TRANSLATIONS: Record<string, Translation> = {
  ...
  "Стандарт печатного PDF: PDF/X-1a:2001 (PDF 1.3, прозрачности сведены)": { de: "Druck-PDF: PDF/X-1a:2001 (PDF 1.3, Transparenzen reduziert)", en: "Print PDF: PDF/X-1a:2001 (PDF 1.3, transparency flattened)", uk: "Друкований PDF: PDF/X-1a:2001 (PDF 1.3, прозорість зведено)" },
  "CMYK-профиль выбирается перед формированием PDF.": { de: "Das CMYK-Profil wird vor der PDF-Erstellung ausgewählt.", en: "Choose the CMYK profile before creating the PDF.", uk: "CMYK-профіль вибирається перед створенням PDF." },
  "Профиль бумаги для печатного PDF": { de: "Papierprofil für das Druck-PDF", en: "Paper profile for print PDF", uk: "Профіль паперу для друкованого PDF" },
  "Для какой бумаги подготовить PDF?": { de: "Für welches Papier soll das PDF erstellt werden?", en: "Which paper is this PDF for?", uk: "Для якого паперу підготувати PDF?" },
  "Выберите бумагу по данным заказа. Цвета будут преобразованы в соответствующий CMYK-профиль, а прозрачности сведены.": { de: "Wählen Sie das Papier laut Bestellung. Farben werden in das passende CMYK-Profil umgewandelt und Transparenzen reduziert.", en: "Choose the paper specified in your order. Colors will use its CMYK profile and transparency will be flattened.", uk: "Виберіть папір за даними замовлення. Кольори буде перетворено у відповідний CMYK-профіль, а прозорість зведено." },
  "Мелованная глянцевая или матовая бумага": { de: "Gestrichenes glänzendes oder mattes Papier", en: "Coated glossy or matte paper", uk: "Крейдований глянцевий або матовий папір" },
  "Немелованная белая бумага": { de: "Ungestrichenes weißes Papier", en: "Uncoated white paper", uk: "Некрейдований білий папір" },
  "Немелованная желтоватая бумага": { de: "Ungestrichenes gelbliches Papier", en: "Uncoated yellowish paper", uk: "Некрейдований жовтуватий папір" },
  "Другая бумага или типография": { de: "Anderes Papier oder andere Druckerei", en: "Other paper or print shop", uk: "Інший папір або друкарня" },
  "Нужен CMYK ICC-профиль типографии": { de: "CMYK-ICC-Profil der Druckerei erforderlich", en: "CMYK ICC profile from the print shop required", uk: "Потрібен CMYK ICC-профіль друкарні" },
  "Загрузить ICC-профиль…": { de: "ICC-Profil laden…", en: "Upload ICC profile…", uk: "Завантажити ICC-профіль…" },
  "Сформировать PDF для печати": { de: "Druck-PDF erstellen", en: "Create print PDF", uk: "Створити PDF для друку" },
  "Формирование…": { de: "Wird erstellt…", en: "Creating…", uk: "Створення…" },
  "Создаём исходный PDF с изображениями и шрифтами": { de: "PDF mit Bildern und Schriften wird erstellt", en: "Creating the PDF with images and fonts", uk: "Створюємо PDF із зображеннями та шрифтами" },
  "Загружаем PDF на сервер": { de: "PDF wird auf den Server hochgeladen", en: "Uploading PDF to the server", uk: "Завантажуємо PDF на сервер" },
  "Сводим прозрачности и преобразуем цвета в CMYK": { de: "Transparenzen werden reduziert und Farben in CMYK umgewandelt", en: "Flattening transparency and converting colors to CMYK", uk: "Зводимо прозорість і перетворюємо кольори на CMYK" },
  "Прошло": { de: "Vergangene Zeit", en: "Elapsed", uk: "Минуло" },
  "Обработка может занять несколько минут. Не закрывайте вкладку.": { de: "Die Verarbeitung kann einige Minuten dauern. Schließen Sie diesen Tab nicht.", en: "Processing may take several minutes. Keep this tab open.", uk: "Обробка може тривати кілька хвилин. Не закривайте вкладку." },
  ...
  "Для PDF/X-1a нужен CMYK ICC/ICM-профиль типографии.": { de: "Für PDF/X-1a wird ein CMYK-ICC/ICM-Profil der Druckerei benötigt.", en: "PDF/X-1a requires a CMYK ICC/ICM profile from the print shop.", uk: "Для PDF/X-1a потрібен CMYK ICC/ICM-профіль друкарні." },
