...
export const TRANSLATIONS: Record<string, Translation> = {
  ...
  "Отрисовываем страницы календаря": { de: "Kalenderseiten werden gerendert", en: "Rendering calendar pages", uk: "Відтворюємо сторінки календаря" },
  "Передаём страницы на сервер": { de: "Seiten werden an den Server übertragen", en: "Uploading pages to the server", uk: "Передаємо сторінки на сервер" },
  "Создаём CMYK PDF/X-1a из страниц календаря": { de: "CMYK PDF/X-1a aus den Kalenderseiten wird erstellt", en: "Creating CMYK PDF/X-1a from calendar pages", uk: "Створюємо CMYK PDF/X-1a зі сторінок календаря" },
  "Прошло": { de: "Vergangene Zeit", en: "Elapsed", uk: "Минуло" },
  "Сервер собирает страницы в печатный PDF. Не закрывайте вкладку.": { de: "Der Server erstellt das Druck-PDF aus den Seiten. Schließen Sie diesen Tab nicht.", en: "The server is assembling the print PDF. Keep this tab open.", uk: "Сервер збирає сторінки в PDF для друку. Не закривайте вкладку." },
