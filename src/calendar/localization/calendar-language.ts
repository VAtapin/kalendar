...
const FOOD_LABELS: Record<CalendarLanguage, Record<FoodRuleId, string>> = {
  ru: { "no-fast": "", fast: "постный день", fish: "разрешается рыба", oil: "пища с маслом", "boiled-no-oil": "пища без масла", "dry-eating": "сухоядение", "strict-fast": "строгий пост", caviar: "разрешается икра", "total-abstinence": "воздержание от пищи", "dairy-eggs": "молочное и яйца", memorial: "поминовение усопших" },
  cu: { "no-fast": "", fast: "де́нь по́стный", fish: "ры́ба разреша́етсѧ", oil: "пи́ща съ є҆ле́емъ", "boiled-no-oil": "варе́нїе безъ є҆ле́а", "dry-eating": "сꙋхояде́нїе", "strict-fast": "стро́гїй по́стъ", caviar: "разрѣша́етсѧ и҆кра̀", "total-abstinence": "воздержа́нїе ѿ пи́щи", "dairy-eggs": "мле́чнаѧ пи́ща и҆ ѧ҆́йца", memorial: "помина́нїе ѹ҆со́пшихъ", ...CHURCH_SLAVONIC_FOOD_CORRECTIONS },
  de: { "no-fast": "", fast: "Fasttag", fish: "Fisch erlaubt", oil: "Speise mit Öl", "boiled-no-oil": "gekochte Speise ohne Öl", "dry-eating": "Trockenkost", "strict-fast": "strenges Fasten", caviar: "Fischrogen erlaubt", "total-abstinence": "völliger Nahrungsverzicht", "dairy-eggs": "Milchprodukte und Eier", memorial: "Totengedenken" },
  uk: { "no-fast": "", fast: "пісний день", fish: "дозволяється риба", oil: "їжа з олією", "boiled-no-oil": "варена їжа без олії", "dry-eating": "сухоїдіння", "strict-fast": "суворий піст", caviar: "дозволяється ікра", "total-abstinence": "повне утримання від їжі", "dairy-eggs": "молочні продукти та яйця", memorial: "поминання спочилих" },
  pl: { "no-fast": "", fast: "dzień postny", fish: "ryba dozwolona", oil: "pokarm z olejem", "boiled-no-oil": "potrawa gotowana bez oleju", "dry-eating": "suche pokarmy", "strict-fast": "ścisły post", caviar: "ikra dozwolona", "total-abstinence": "całkowite powstrzymanie się od jedzenia", "dairy-eggs": "nabiał i jajka", memorial: "wspomnienie zmarłych" },
};
