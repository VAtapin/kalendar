...
describe("interface languages", () => {
  it('prioritizes explicit language paths, otherwise the domain (not browser)', () => {
    ...
    expect(resolveBrowserLanguage('/', ['fr-FR', 'de-DE'], 'kalender.georg-kloster.ru')).toBe('ru');
    expect(resolveBrowserLanguage('/impressum', ['uk-UA'], 'kalender.georg-kloster.de')).toBe('de');
    expect(resolveBrowserLanguage('/', ['fr-FR'])).toBe('ru');
