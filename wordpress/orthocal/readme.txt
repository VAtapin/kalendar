...
== Установка ==
1. WordPress → Плагины → Добавить плагин → Загрузить: orthocal-1.3.3.zip.
...
Общие параметры: lang="ru|cu|de|uk|pl", profile="typikon-strict|parish", theme="book|modern|inherit", compact="0|1", oldstyle="0|1". Пустая дата — текущая дата в часовом поясе WordPress. Годы 1900–2200.
