...
== Установка ==
1. WordPress → Плагины → Добавить плагин → Загрузить: orthocal-1.1.0.zip.
2. Активируйте плагин.
3. Настройки → Православный календарь: сохраните ключ календаря и проверьте оба API.
...
== Возможности ==
19 динамических блоков Gutenberg и шорткодов, шесть вкладок настроек, конструктор с предпросмотром, встроенная помощь, серверный HTML, переключение дат без перезагрузки, всплывающие окна, поиск памятей дня, постоянные ссылки ?orthocal_date=YYYY-MM-DD, независимые блоки, три оформления, мобильная адаптация, печатные стили, клавиатурное управление.
