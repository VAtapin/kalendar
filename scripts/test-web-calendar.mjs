...
try{
 ...
 const makeDay=date=>{const pascha=date.endsWith('-02-01'),title=pascha?'Светлое Христово Воскресение. Пасха':'Святитель Николай';return {date,weekday:new Date(date+'T12:00:00Z').getUTCDay(),oldStyleDate:'2026-08-29',foodLabel:pascha?'поста нет':'пища с маслом',dayStyle:{rank:pascha?'pascha':'great-feast'},events:[{category:'commemoration',title,typeCode:pascha?0:2,typikonMark:{id:'great',label:'Великий праздник',svgSource:'/assets/typikon/great.svg'}},{category:'commemoration',title:'Святитель Спиридон',typeCode:6},{category:'commemoration',title:'Мученица Наталья',typeCode:6},{category:'commemoration',title:'Преподобный Сергий',typeCode:6}],icons:[{id:1,title:'Святитель Николай',description:'Описание иконы',images:[{url:'https://bible-desktop.com/api/calendar/icons/1/images/2'},{url:'https://bible-desktop.com/api/calendar/icons/1/images/3'}]},{id:2,title:'Мученица Наталья Козлова',description:'Описание второй иконы',images:[{url:'https://bible-desktop.com/api/calendar/icons/2/images/4'}]}],foodMarkers:[{source:'/assets/markers/ornamental/fast-no-fish.png'}]};};
